...
const plans = [
  {
    name: "Hobby",
    price: 12,
    description: "For hobby, staging sites, and side hustles and personal projects.",
    features: [
      "2 pages",
      "Limited traffic",
      "50 form submissions",
  ...
  return (
    <section className="py-16 px-4 md:px-6 relative">
      <div className="container mx-auto px-4 sm:px-8 lg:px-12">
        ...
        <div className="flex justify-center mb-8">
          <div className="inline-flex items-center bg-muted rounded-full p-1">
            ...
            >
              Bill Yearly <span className="text-orange-600 font-bold">-20%</span>
            </button>
            <button
                ...
                <ul className="space-y-2">
                  {plan.features.map((feature, i) => (
                    <li key={i} className="flex items-center gap-2">
                      <Check className={`h-4 w-4 ${plan.highlighted ? 'text-slate-50' : 'text-orange-500'}`} />
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <Printer className="absolute w-60 h-60 text-orange-500/20 opacity-40 -z-10 top-20 right-10" strokeWidth={3} />
